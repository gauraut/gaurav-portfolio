...
export default function Experience() {
  return (
    <motion.section
      id="experience"
      className="py-6 px-4 sm:px-6 md:px-24 bg-gray-900 text-white font-mono transform"
    ...
    >
      ...
      <div className="flex items-center space-x-2 mb-6 text-xl sm:text-1xl md:text-4xl">
